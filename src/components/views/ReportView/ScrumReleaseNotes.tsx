...
import { useStore, getBoardScope, jiraOnBoard, getActiveBoardId, sprintMatchesBoard, getActiveJiraConn } from '../../../store'
...
export default function ScrumReleaseNotes() {
  ...
  const { developers, projects, sprints, selectedProject, selectedDev, releaseNoteData, updateReleaseNoteIssue, releaseNoteColumns, setReleaseNoteColumns } = state
